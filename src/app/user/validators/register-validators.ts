...
//static ois needed because if we don't write it we need to call the function like this:
// new RegisterValidators.match() <- Without static
// RegisterValidators.match() <- with static ---are limited with their scope---
